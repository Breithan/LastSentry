...
public class SC_PU03 : MonoBehaviour
{
    ...
    public void EnableSkill()
    {
        ...
        GetComponent<SC_PlayerShip>().StartSkill(20);
        GameObject.Find("SpawnManager").GetComponent<SC_Spawns>().SpawnRepeat(0, (0.7f / PlayerPrefs.GetFloat("Hardship")));
